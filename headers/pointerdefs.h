...
FUNCPTR(Base, GetMouseXOffset, long __fastcall, (), 0x5AFC0)
FUNCPTR(Base, GetMouseYOffset, long __fastcall, (), 0x5AFB0)
...
// //004F6510-BASE
FUNCPTR(D2GFX, DrawRectangle, void __stdcall, (int X1, int Y1, int X2, int Y2, DWORD dwColor, DWORD dwAlpha), 0xF6340) // Updated 1.14d //004F6340-BASE
FUNCPTR(D2GFX, DrawLine, void __stdcall, (int X1, int Y1, int X2, int Y2, DWORD dwColor, DWORD dwAlpha), 0xF6380)        // Updated 1.14d //004F6380-BASE
...
FUNCPTR(D2GFX, GetScreenMode, DWORD __stdcall, (), 0xF5160) // NEW 1.14d //004F5160-BASE
